...
export default async function handler(
  ...
  try {
    ...
    // 🔹 Requête SQL pour récupérer les achats par mois en croisant avec `data_globalproduct`
    const query = `
      SELECT 
    ...
    console.error("Erreur lors de la récupération des achats par mois :", error);
