...
interface FlopLabDistributorsListProps {
...
const FlopLabDistributorsList: React.FC<FlopLabDistributorsListProps> = ({ distributors, loading }) => {
  ...
  // Tri des laboratoires par CA croissant pour les flops
  const sortedDistributors = [...filteredDistributors].sort((a, b) => a.revenue - b.revenue);
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-lg p-4 h-full">
      <div className="flex items-center gap-4 mb-4">
        ...
        <h2 className="text-lg font-bold text-gray-800">Flop 10 Lab Distributors</h2>
      </div>
      {loading ? (
...
export default FlopLabDistributorsList;