...
const TopPurchasesByProductsList: React.FC = () => {
  const { topProducts, loading } = useTopPurchasesProductsContext();
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-lg p-4 h-full">
      <div className="flex items-center gap-4 mb-4">
        ...
        <h2 className="text-lg font-bold text-gray-800">Top 10 Produits Achetés</h2>
      </div>
      {loading ? (
...
export default TopPurchasesByProductsList;