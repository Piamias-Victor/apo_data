...
const TopPurchasesByLabDistributorsList: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 shadow-xl rounded-lg p-4 h-full">
      <div className="flex items-center gap-4 mb-4">
        ...
        <h2 className="text-lg font-bold text-gray-800">Top 10 Achats par Distributeur</h2>
      </div>
      {loading ? (
...
export default TopPurchasesByLabDistributorsList;